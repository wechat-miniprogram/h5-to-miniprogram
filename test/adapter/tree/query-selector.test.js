...
const QuerySelector = load('QuerySelector')
...
test('query-selector: exec select', () => {
  ...
  expect(querySelector.exec('#bb .bb1', document.body, getExtra(document))[0]).toBe(document.body.querySelector('#bb .bb1'))
  expect(querySelector.exec('div.bb header', document.body, getExtra(document))[0]).toBe(document.body.querySelector('div.bb header'))

  const res1 = querySelector.exec('.bb footer > .bb4', document.body, getExtra(document))
  ...
  expect(querySelector.exec('.bb footer > .bb4:nth-child(2)', document.body, getExtra(document))[0]).toBe(document.body.querySelector('.bb footer > .bb4:nth-child(2)'))
  expect(querySelector.exec('.bb footer > .bb4:first-child', document.body, getExtra(document))[0]).toBe(document.body.querySelector('.bb footer > .bb4:first-child'))
  expect(querySelector.exec('.bb footer > .bb4:last-child', document.body, getExtra(document))[0]).toBe(document.body.querySelector('.bb footer > .bb4:last-child'))

  const res3 = querySelector.exec('.bb footer > .bb4:nth-child(2n-1)', document.body, getExtra(document))

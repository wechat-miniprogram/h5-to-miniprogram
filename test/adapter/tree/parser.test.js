  ...
  expect(res[0]).toEqual({
    ...
    children: [{
      ...
      children: [{
        ...
        type: 'element',
        tagName: 'meta',
        attrs: [{name: 'name', value: 'viewport'}, {name: 'content', value: 'width=device-width, initial-scale=1.0'}],
        unary: true,
        children: [],
      }, {
        type: 'element',
        tagName: 'meta',
        attrs: [{name: 'http-equiv', value: 'X-UA-Compatible'}, {name: 'content', value: 'ie=edge'}],
        unary: true,
        children: [],
      }, {
        type: 'element',
        ...
        type: 'element',
        tagName: 'link',
        attrs: [{name: 'rel', value: 'stylesheet'}, {name: 'href', value: './css/a.css'}],
        unary: true,
        children: [],
      }, {
        type: 'element',
        tagName: 'link',
        attrs: [{name: 'rel', value: 'stylesheet'}, {name: 'href', value: './css/b.css'}],
        unary: true,
        children: [],
      }, {
        type: 'element',
      ...
      children: [{
        ...
        type: 'element',
        tagName: 'script',
        attrs: [{name: 'src', value: './js/a.js'}],
        unary: false,
        children: [],
      }, {
        type: 'element',
        tagName: 'script',
        attrs: [{name: 'src', value: './js/b.js'}],
        unary: false,
        children: [],
      }, {
        type: 'element',
        ...
        attrs: [],
        unary: false,
        children: [{type: 'text', content: 'console.log(\'hello\');'}],
      }],
    }],
  })
})
